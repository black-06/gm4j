...
public class SM2Test {
    ...
    public void part2_A1() {
        ...
        int len = ID_A.length * 8;
        byte[] entl = new byte[2];
        entl[0] = (byte) (len >> 8 & 255);
        entl[1] = (byte) (len & 255);
        assertHexEquals("0090", entl);
    }
    ...
    public void testZ() {
        ...
        // 公钥 p
        ECPoint pa = SM2.multiplyG(d);
        // Z
        byte[] z = SM2.generateZ(ID_A, pa);
    ...
    public void part3_A2() {
        ...
        // 椭圆曲线点 V (xv,yv)
        ECPoint v = SM2.multiply(p, SM2.getH().multiply(tb));
        ...
        // kb
        byte[] kb = SM2.kdf(16, xv, yv, za, zb);
        ...
        // U
        ECPoint u = SM2.multiply(p, SM2.getH().multiply(ta));
        ...
        // ka
        byte[] ka = SM2.kdf(16, xu, yu, za, zb);
